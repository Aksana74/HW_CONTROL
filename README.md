...
##ОПИСАНИЕ алгоритма решения:
    ...
    2. Применяем метод, в котором внутри цикла провряем ус ловие (<=3). Если условие выполняется "Да", то элемент первого массива заносится в count элемент второго массива. После присвоения переменная count увеличивается на 1 и возвращается к циклу for в котором i  увеличивается на 1. И так провряем до конца. 
    3. Печать массива.